...
/*   Updated: 2023/03/16 16:33:19 by acouture         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sorting_5(t_data *data)
{
	...
	sorting_3(data);
	push_a(data);
	last_a = lst_last_node(data->pile_a);
	if ((*data->pile_a)->data > last_a->data)
		first_to_last_a(data);
	push_a(data);
	last_a = lst_last_node(data->pile_a);
	// if ((*data->pile_a)->data > (*data->pile_a)->next->data
	// 	&& (*data->pile_a)->data < last_a->data)
	// 	swap_a(data);
}
